  ...
  return {
    ...
    reports: {
      ...
      artifactCompletion: {
        ...
        lastGeneratedLabel: "May 12, 2024 9:19 AM",
        viewHref: `${basePath}/artifact-completion`,
        exportPdfHref: `/api/reports/${projectId}/artifact-completion.pdf`,
      },
      evidenceCompleteness: {
        ...
        low: 5,
        blockingGates: 2,
        lastGeneratedLabel: "May 12, 2024 9:21 AM",
        viewHref: `${basePath}/evidence-completeness`,
        exportCsvHref: `/api/reports/${projectId}/evidence-completeness.csv`,
      },
      traceability: {
